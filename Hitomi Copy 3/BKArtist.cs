...
{
    public partial class BKArtist : Form
    {
        frmBookmark parent;

        public BKArtist(frmBookmark parent, string artist = "", string score = "1")
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (tbSearch.Text == "")
            {
                MessageBox.Show("작가를 입력해주세요.", "Custom Recommendation", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            parent.Post(() => parent.RequestAddArtist(tbSearch.Text));
        ...
        private void tbSearch_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            List<HitomiTagdata> match = HitomiData.Instance.GetArtistList(word, true);
