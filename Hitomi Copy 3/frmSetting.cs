...
namespace Hitomi_Copy_3
{
    public partial class frmSetting : Form
    {
        ...
        private void bSave_Click(object sender, EventArgs e)
        {
            ...
            if (tgXA.Checked == true && tgCA.Checked == true)
            {
                MessageBox.Show("Xi Analysis와 Cosine Analysis는 같이 사용할 수 없습니다.", Text, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            if (tgRMS.Checked == true && tgCA.Checked == true)
            {
                MessageBox.Show("RMS Analysis와 Cosine Analysis는 같이 사용할 수 없습니다.", Text, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
